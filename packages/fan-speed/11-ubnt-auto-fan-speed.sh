...
# =============================================================================
# Credits
# Project: ubnt-auto-fan-speed
# Author: renedis
# Github: https://github.com/renedis/ubnt-auto-fan-speed
# Github User: https://github.com/renedis
# License: No License
# =============================================================================



# Stop built-in fan control
...
# Set fan speed
# 0 = FULL     (Fans runnning at full speed)
...
UBIOS_CPU_MINIMAL_DUTY_FAN_PWM='75'        # default 128, this sets the minimal RPM for the CPU fan
